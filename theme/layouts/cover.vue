    ...
    <div class="my-auto w-full">
      <div class="mb-20">
        <div ref="webpack" class="inline-block pointer-events-none mr-20">
          <img src="https://nuxt.com/assets/design-kit/logo/icon-green.svg" width="60" height="60" class="h-60px" style="margin: 0;">
        </div>
        <div ref="rollup" class="inline-block pointer-events-none mr-10">
          <logos-vueuse height="60" width="60" class="h-60px" />
        </div>
        <div ref="vite" class="inline-block ml-10">
          <fluent-triangle-16-regular height="60" width="60" class="h-60px" />
        </div>
      </div>
      <div>
        <slot />
